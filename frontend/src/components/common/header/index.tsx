    ...
    <header className="h-[100vh]  w-[230px] flex flex-col justify-between items-center box-border py-[36px] fixed border-r">
      ...
      <div className="flex flex-col gap-[50px] ">
        <Link
          ...
          className={`rounded-[12px] w-full px-[5px] py-[5px] hover:bg-[#e5f9c1] transition ease-in-out delay-50 ${isSelected === "/repos" ? "bg-[#e5f9c1]" : "bg-white"}`}
        >
        ...
        <Link
          ...
          className={`rounded-[12px] p-[5px] hover:bg-[#e5f9c1] transition ease-in-out delay-50 ${isSelected === "/dashboard" ? "bg-[#e5f9c1]" : "bg-white"}`}
        >
        ...
        <Link
          ...
          className={`rounded-[12px] p-[5px] hover:bg-[#e5f9c1] transition ease-in-out delay-50 ${isSelected === "/report" ? "bg-[#e5f9c1]" : "bg-white"}`}
        >
          <div className="flex items-center gap-2 ">
        ...
        <Link
          ...
          className={`rounded-[12px] px-[5px] py-[5px] hover:bg-[#e5f9c1] transition ease-in-out delay-50 ${isSelected === "/guide" ? "bg-[#e5f9c1]" : "bg-white"}`}
        >
          <div className="flex items-center gap-2 ">
